...
const DialogFooter = ({ children, className = "" }: DialogFooterProps) => (
  <div className={`p-4 sm:p-6 pt-2 sm:pt-4 border-t border-gray-100 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 space-y-2 space-y-reverse sm:space-y-0 ${className}`}>
    {children}
  </div>
)
