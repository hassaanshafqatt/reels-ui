  ...
  return (
    <div className="bg-gray-50 p-1 rounded-xl">
      <div className="grid grid-cols-2 gap-1">
        ...
        <SimpleTooltip
          content="Let AI automatically create engaging captions based on your reel content and type"
          side="top"
        >
          <button
        ...
        <SimpleTooltip
          content="Write your own custom caption with full control over the message and tone"
          side="top"
        >
          <button
